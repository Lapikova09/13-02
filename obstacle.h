...
void respawn(Obstacle& obs) {
	...
	else if (choice1 == 2) { obs.texture.loadFromFile("carcar.png"); }
	sf::Vector2f first{ 150.f, -10.f };
	sf::Vector2f second{ 200.f, -10.f };
	sf::Vector2f third{ 250.f, -10.f };
	sf::Vector2f fourth{ 300.f, -10.f };
	int choice = rand() % 4 + 1;
